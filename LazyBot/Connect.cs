...
namespace LazyBot
{
	...
	public class Connect : IDTExtensibility2, IDTCommandTarget
	{
		...
		public void OnConnection(object application, ext_ConnectMode connectMode, object addInInst, ref Array custom)
		{
			...
			if(connectMode == ext_ConnectMode.ext_cm_UISetup)
			{
				...
				try
				{
					...
					Command command = commands.AddNamedCommand2(_addInInstance, "LazyBot", "LazyBot", "Executes the command for LazyBot", true, 59, ref contextGUIDS, (int)vsCommandStatus.vsCommandStatusSupported+(int)vsCommandStatus.vsCommandStatusEnabled, (int)vsCommandStyle.vsCommandStylePictAndText, vsCommandControlType.vsCommandControlTypeButton);
        ...
        private BotParser _botParser = new BotParser();
        private BotRequest _botRequest = new BotRequest();
	}
}